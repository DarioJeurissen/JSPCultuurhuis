...
public class KlantenRepository extends AbstractRepository {
    ...
    private static final String INSERT_KLANT_SQL = "INSERT INTO klanten(klantid, voornaam, familinaam, straat, huisnr, postcode, gemeente, gebruikersnaam, passwoord) values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public void insertKlantInDB(Klant k){
		try (Connection connection = dataSource.getConnection();
            ...
            connection.setAutoCommit(false);
	            ...
	            int insertedKlant = statementInsert.executeUpdate();
	            if(insertedKlant == 1){
	            	connection.commit();
	            }
